...
const TEMPLATES = [
  {
    ...
    desc: 'Professional C-suite reporting',
    component: ExecutiveSummaryTemplate,
  },
  {
    id: 'analytics',
    name: '📊 Analytics Focus',
    desc: 'Data analysis with main + sidebar charts',
    component: AnalyticsFocusTemplate,
  },
  {
    id: 'performance',
    name: '⚡ Performance Metrics',
    desc: 'Real-time monitoring dashboard',
    component: PerformanceMetricsTemplate,
  },
  {
    id: 'minimal',
    name: '✨ Minimal Clean',
      ...
      <div className="db-main">
        ...
        {selectedTemplate && (
          <div className="template-view-wrapper">
            {(() => {
              const charts = (dashboardConfig?.charts || []).map((c) => {
                const data = buildDataset(c, filteredData);
                return { ...c, data };
              });
              
              const templateMetrics = dashboardConfig?.metrics?.map((m) => ({
                label: m.label,
                value: metrics[m.id]?.value || 0,
              ...
              return TemplateComponent ? (
                <TemplateComponent charts={charts} metrics={templateMetrics} />
              ) : null;
            })()}
          </div>
        )}
        ...
        {/* ── OVERVIEW TAB ── */}
        {!selectedTemplate && activeTab === 'dashboard' && (
