      ...
      {!dashboardData ? (
        <div style={{ padding: '40px 20px' }}>
          <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', marginBottom: '40px' }}>
            <h1 style={{ fontSize: '2rem', margin: '0 0 12px 0' }}>Minimal Clean Dashboard</h1>
            <p style={{ color: 'var(--text-secondary)' }}>Upload your data to create a minimalist dashboard with elegant typography and spacing</p>
          </div>
          <FileUpload 
